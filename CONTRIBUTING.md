...
Welcome to `cblpython` contributor's guide.
...
If you experience bugs or general issues with `cblpython`, please have a look
...
You can help improve `cblpython` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`cblpython` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `cblpython`'s files. While this mechanism can
...
```
conda create -n cblpython python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/cblpython.git
   cd cblpython
   ```
...
5. Install [pre-commit]:
   ...
   `cblpython` comes with a lot of hooks configured to automatically help the
